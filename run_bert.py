...
import re
import codecs
from bert_model import TBertBiLSTMConfig, TBertBiLSTM
...
save_dir = 'checkpoints/text_bilstm_atten'
...
def load_word2vec(emb_path, id_to_word, word_dim, old_weights):
    ...
    for i, line in enumerate(codecs.open(emb_path, 'r', 'utf-8')):
        line = line.rstrip().split()  # 取出pre_train_file的一行
...
def train():
    ...
    tensorboard_dir = model.tensorboard_dir
